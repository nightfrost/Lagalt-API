...
public class SecurityProperties {
    ...
    public SecurityProperties(CookieProperties cookieProps, FirebaseProperties firebaseProps, boolean allowCredentials, List<String> allowedOrigins, List<String> allowedHeaders, List<String> exposedHeaders, List<String> allowedMethods, List<String> allowedPublicApis) {
